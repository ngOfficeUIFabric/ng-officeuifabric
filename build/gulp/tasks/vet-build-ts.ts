...
export class GulpTask extends BaseGulpTask {
   ...
   */
  public static description: string = 'Run code quality & style analysis on all build-realted ' +
                                      'TypeScript (code used to build & ' + GulpTask.helpMargin + 'maintain project)';
