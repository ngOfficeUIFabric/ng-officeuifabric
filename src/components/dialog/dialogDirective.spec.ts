...
describe('uifDialog: <uif-dialog />', () => {
    ...
    it('should set correct Office UI Fabric attribute [uif-type] on the Dialog',
       inject(
            ($compile: Function, $rootScope: ng.IRootScopeService) => {
    ...
    it('should set correct Office UI Fabric attribute [uif-close] on the Dialog',
       inject(
            ($compile: Function, $rootScope: ng.IRootScopeService) => {
    ...
    it('should validate log messages on uifType',
       inject(
            ($compile: Function, $rootScope: ng.IRootScopeService, $log: ng.ILogService) => {
                element = ng.element('<uif-dialog uif-type="unknown" ></uif-dialog>');
                $compile(element)(scope);
                scope.$digest();
    ...
    it('should set correct Office UI Fabric classes on the DialogContent',
    ...
    it('should set correct Office UI Fabric classes on the DialogInner',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
    ...
    it('should set correct Office UI Fabric classes on the DialogSubText',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
