...
export class TextFieldDirective implements ng.IDirective {
    ...
    '<div ng-class="{\'is-active\': isActive, \'ms-TextField\': true, \'ms-TextField--underlined\': underlined, \'ms-TextField--placeholder\': placeholder}">' +
    ...
    public link(scope: ng.IScope, instanceElement: ng.IAugmentedJQuery, attrs: ng.IAttributes, ngModel: ng.INgModelController): void {
        ...
        if (ngModel != null) {
            ngModel.$render = function() {
                let input = instanceElement.find("input");       
