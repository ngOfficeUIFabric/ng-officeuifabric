...
describe('tableDirective: <uif-table />', () => {
    ...
    it('should reverse the sorting order when selecting the same column for sorting',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
        element = ng.element('<uif-table><uif-table-row><uif-table-header></uif-table-header>\
        <uif-table-header uif-order-by="fileName"></uif-table-header></uif-table-row></uif-table>');
        $compile(element)(scope);
    ...
    it('should clear the sorting indicator after selecting another column for sorting',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
    ...
    it('should change the sorting order to ascending after selecting another column for sorting',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
    ...
    it('should keep the sorting data intact after selecting another column for which sorting hasn\'t been enabled',
       inject(($compile: Function, $rootScope: ng.IRootScopeService) => {
        element = ng.element('<uif-table><uif-table-row><uif-table-header></uif-table-header>\
        <uif-table-header uif-order-by="fileName"></uif-table-header></uif-table-row></uif-table>');
        $compile(element)(scope);
